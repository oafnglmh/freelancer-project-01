<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="index.html">SHOP</a>
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="/chatify">
                <span class="menu-icon">
                    <i class="mdi mdi-message-text" style="color: #007bff;"></i>
                </span>
...
<script>
    $(document).ready(function() {
        $('.sidebar .nav-item.menu-items > a[data-toggle="collapse"]').on('click', function(e) {
            ...
            $('.sidebar .collapse.show').each(function() {
                ...
                var openCollapseId = '#' + $openCollapse.attr('id');
                if (openCollapseId !== targetId) {
                    $openCollapse.collapse('hide');
                    
                    var $relatedLink = $('.sidebar a[href="' + openCollapseId + '"]');
                    $relatedLink.attr('aria-expanded', 'false');
                    
                  
                    $relatedLink.removeClass('expanded'); 
                }
            });
